  ...
  info.forEach((i) => {
    if (x != i.level) {
      if (obj_sep != null) {
        if (count != 1) {
          obj_sep.html(
            "<td colspan='8' class='bg-primary-subtle' id='" +
              mark +
              x +
              "'>" +
              "<b>" +
    ...
    // Main
    var str = $("<tr></tr>");
    if (i.state == 1) str = $("<tr class='bg-info-subtle'></tr>");
    if (i.state == 2) str = $("<tr class='bg-warning-subtle'></tr>");
    if (i.state == 3) str = $("<tr class='bg-success-subtle'></tr>");
    if (i.state == 4) str = $("<tr class='bg-secondary-subtle'></tr>");
    if (i.state == 5) str = $("<tr class='bg-primary-subtle'></tr>");
    if (i.state == 6) str = $("<tr class='bg-success-subtle'></tr>");
